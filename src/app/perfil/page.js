  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const typesResponse = await axios.get('http://18.228.3.214:3001/api/user-types', {
        ...
        const userResponse = await axios.get('http://18.228.3.214:3001/api/users/profile', {
          headers: { Authorization: `${token}` }
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        'http://18.228.3.214:3001/api/users/profile',
        updateData,
        {
          headers: { Authorization: `${token}` }
        }
