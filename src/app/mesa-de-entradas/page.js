...
export default function MesaDeEntradas() {
  ...
  const handleLoadDocuments = async () => {
    ...
    try {
      ...
      const response = await axios.post('http://15.229.87.106:3001/api/files/generate-presigned-url', {
        fileName: fileName,
        fileType: fileType,
      }, {
        headers: {
      ...
      const response1 = await axios.post('http://15.229.87.106:3001/api/files/save-file-data', {
        fileName: fileName,
...
//      const responseML = await axios.post('http://15.229.87.106:5000/detect_file', {
//        fileName: fileName,
//        realFileName: realFileName,
//        fileType: fileType,
//      });
      ...
      const responseML = await fetch('http://15.229.87.106:5000/detect_file', {
        method: 'POST',
        headers: {
      ...
      const reportResponse = await axios.post(
        'http://15.229.87.106:3001/api/reports/create',
        {
          fileData: data,
          fileId: fileId
        },
      ...
      const updateFile = await axios.put(
        `http://15.229.87.106:3001/api/files/update/${fileId}`,
        {
          mlData: data,
      ...
      const alertResponse = await axios.post(
        'http://15.229.87.106:3001/api/alerts/',
        {
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <span>{mlData?.[mlData.tipo]?.Rol_GCBA || 'actor/demandado'}</span>
                </div>
